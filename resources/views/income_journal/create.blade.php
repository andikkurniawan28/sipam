...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="mb-4"><strong>Tambah jurnal pemasukan</strong></h4>

    <div class="card">
        <div class="card-body">
            <form id="form-income" action="{{ route('income_journal.store') }}" method="POST">
                @csrf
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('income_journal.index') }}" class="btn btn-secondary me-2">Batal</a>
